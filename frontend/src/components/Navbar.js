    ...
    <div>
      <nav style={styles.topNavbar}>
        <h1 style={styles.logo} onClick={() => navigate("/")}>
          Foodie Haven <span style={styles.icon}>🍕</span>{" "}
          {/* Updated site name and emoji */}
        </h1>
...
const styles = {
  topNavbar: {
    ...
    background: "offwhite", // Updated background color
  ...
  logo: {
    ...
    color: "orange", // Updated color for visibility against the new background
    cursor: "pointer",
  ...
  icon: {
    width: "45px",
    height: "45px", // Adjusted the size of the emoji
  },
  navButtons: {
    display: "flex",
    gap: "12px",
